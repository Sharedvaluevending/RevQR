...
INSERT INTO loot_box_openings (user_id, purchase_id, qr_store_item_id, rewards_json, total_rewards, opened_at) VALUES
(1, 1, 1, '[{"type":"qr_coins","amount":150,"display":"150 QR Coins","rarity":"common","icon":"bi-coin"},{"type":"spins","amount":3,"display":"3 Spin Wheel Spins","rarity":"common","icon":"bi-arrow-repeat"}]', 2, NOW()),
(1, 2, 2, '[{"type":"qr_coins","amount":350,"display":"350 QR Coins","rarity":"rare","icon":"bi-coin"},{"type":"boost","boost_type":"spin_multiplier","duration":48,"display":"48h Spin Multiplier (2x)","rarity":"rare","icon":"bi-lightning"}]', 2, NOW());
