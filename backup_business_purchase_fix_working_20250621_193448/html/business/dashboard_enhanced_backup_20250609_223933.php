<?php
/**
 * Enhanced Business Dashboard - Phase 3 Step 3 Optimization
 * PRESERVES ALL ORIGINAL DASHBOARD CARDS + ADDS NEW ANALYTICS
 */
...
<div class="container-fluid py-4">
    ...
    <div class="welcome-section fade-in">
        <div class="row align-items-center">
            ...
            <!-- Enhanced Action Buttons with View Toggle -->
            <div class="col-auto">
                <div class="d-flex gap-2">
                    <!-- System Status Badge -->
                    <span class="btn btn-outline-<?php echo $capabilities['is_unified'] ? 'warning' : ($capabilities['has_nayax'] ? 'primary' : 'success'); ?>" style="cursor: default;">
                        <i class="bi bi-<?php echo $capabilities['is_unified'] ? 'intersect' : ($capabilities['has_nayax'] ? 'wifi' : 'qr-code'); ?> me-1"></i>
                        <?php 
                        if ($capabilities['is_unified']) {
                            echo 'Unified System';
                        } elseif ($capabilities['has_nayax']) {
                            echo 'Nayax System';
                        } else {
                            echo 'Manual System';
                        }
                    ...
                    <div class="btn-group" role="group">
                        <button type="button" class="btn btn-light active" title="Full Cards View">
                            <i class="bi bi-grid-3x3-gap me-1"></i>Cards
                        </button>
                        <a href="<?php echo APP_URL; ?>/business/dashboard.php?view=unified" class="btn btn-outline-light" title="Unified View">
                            <i class="bi bi-speedometer2 me-1"></i>Unified
                        </a>
                    </div>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="d-flex gap-2 flex-wrap">
                                <a href="business-guide.php" class="btn btn-primary btn-sm">
                                    <i class="bi bi-book-half me-1"></i>Business Guide
                                </a>
                                <a href="wallet.php" class="btn btn-warning btn-sm">
                                    <i class="bi bi-wallet2 me-1"></i>QR Wallet
                                </a>
                                ...
                                <a href="qr-analytics.php" class="btn btn-success btn-sm">
                                    <i class="bi bi-graph-up me-1"></i>QR Analytics
                                </a>
                            </div>
                        </div>
                    </div>
    ...
    <!-- Dashboard Cards Grid (ORIGINAL PRESERVED) -->
    <!-- Row 1: Vote, Engage, Sales -->
    ...
    <!-- Row 2: Inventory, Cross Ref, Performance Analytics -->
    <div class="row g-4 card-row">
        <div class="col-12 col-md-4">
            <div class="equal-height">
    ...
    <!-- Row 3: Promotions, Spins, Pizza Tracker -->
    <div class="row g-4 card-row">
        <div class="col-12 col-md-4">
            <div class="equal-height">
    ...
    <!-- Row 4: Nayax Integration & Casino Participation -->
    <div class="row g-4 card-row">
