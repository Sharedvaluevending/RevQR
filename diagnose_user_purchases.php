<?php
/**
 * User-Specific Purchase Diagnostic Script
 * 
 * This script helps diagnose issues where a user's transactions don't 
 * match their purchases/discounts
 */
...
echo "Enter your username or user ID: ";
